...
const AGENDA = {
  friday: [
    ...
    { time: '2:30',  ampm: 'PM', title: 'Workshop · How to Code Like a One-Man Army',         speaker: 'Max Forsey · Daso' },
    { time: '3:00',  ampm: 'PM', title: 'Workshop · Agent Resource Management',               speaker: 'Jacob Petterle · School AI' },
    { time: '3:30',  ampm: 'PM', title: 'Workshop · Build Your Company’s AI Brain',           speaker: 'Isaac Tai' },
    { time: '4:30',  ampm: 'PM', title: 'Workshop · Harness Engineering',                     speaker: 'Jacob Wright · MadeThis' },
  ],
  saturday: [
    { time: '8:00',  ampm: 'AM', title: 'Building Opens · Breakfast', speaker: '' },
    { time: '10:00', ampm: 'AM', title: 'Workshop for Beginners',     speaker: 'Jacob Wright · MadeThis' },
